import{$b as u,Wb as y,Xb as F,jc as f,kc as b,lc as R,mc as v}from"./chunk-LFLB3D3T.js";var _=2,S=`
...
`,g="material.ccParams.x * textureSample(ccIntensityTexture, ccIntensitySampler_, input.uv).r",N="material.ccParams.x",I="clamp(material.ccParams.y * textureSample(ccRoughnessTexture, ccRoughnessSampler_, input.uv).g, 0.0, 1.0)",T="material.ccParams.y",P=`
...
`}function H(c,l,e,t,r){if((c&u)===0)return null;let a=(c&(y|F))!==0,n=(l&f)!==0,i=(l&b)!==0,o=(l&R)!==0,h=(l&v)!==0,s=n?g:N,x=i?I:T,d={MF:h?"":E(s),AD:L(s,x,o),BL:`var ccDirectAttenuation = 1.0;
var ccDirectSpecularTerm = vec3<f32>(0.0);`};o&&(d.AC=P),e?d.AI=D(s,x,o,r,t):d.NI=k(s);let m=[];e&&m.push("ibl"),a&&m.push("reflectance");let C=(n?"I":"")+(i?"R":"")+(o?"N":"")+(h?"X":"")+(r?"A":"")+(t?"B":""),p=[];return n&&p.push({_name:"ccIntensityTexture",_type:{_kind:"texture",_textureType:"texture_2d<f32>"},_visibility:_},{_name:"ccIntensitySampler_",_type:{_kind:"sampler",_samplerType:"sampler"},_visibility:_}),i&&p.push({_name:"ccRoughnessTexture",_type:{_kind:"texture",_textureType:"texture_2d<f32>"},_visibility:_},{_name:"ccRoughnessSampler_",_type:{_kind:"sampler",_samplerType:"sampler"},_visibility:_}),o&&p.push({_name:"ccNormalTexture",_type:{_kind:"texture",_textureType:"texture_2d<f32>"},_visibility:_},{_name:"ccNormalSampler_",_type:{_kind:"sampler",_samplerType:"sampler"},_visibility:_}),{_id:C?`clearcoat-${C}`:"clearcoat",_dependencies:m.length>0?m:void 0,_uboFields:[{_name:"ccParams",_type:"vec4<f32>"},{_name:"ccRefractionParams",_type:"vec4<f32>"}],_bindings:p,_helperFunctions:S,_fragmentSlots:d}}function M(c,l,e){let t=l.clearCoat;if(!t?.isEnabled||!e.has("ccParams"))return;let r=e.get("ccParams")/4,a=t.indexOfRefraction??1.5,n=1-a,i=1+a;c[r]=t.intensity??1,c[r+1]=t.roughness??0,c[r+2]=t.bumpTextureScale??1,c[r+4]=Math.pow(-n/i,2),c[r+5]=1/a,c[r+6]=n,c[r+7]=i}var A=[[f,"texture"],[b,"roughnessTexture"],[R,"bumpTexture"]],V={id:"clearcoat",phase:"base-tex",detect(c){let l=c.clearCoat;if(!l?.isEnabled)return{f:0,f2:0};let e=0;for(let[t,r]of A)l[r]&&(e|=t);return l.useF0Remap===!1&&(e|=v),{f:u,f2:e}},frag:c=>H(c._features,c._features2,c._hasIbl,c._hasAnyNormal,c._hasSpecularAA),writeUbo:M,bind(c,l,e){let t=c._material.clearCoat;if(!t)return e;for(let[r,a]of A){let n=t[a];(c._features2&r)!==0&&n&&(l.push({binding:e++,resource:n.view}),l.push({binding:e++,resource:n.sampler}))}return e},textures(c,l){let e=c.clearCoat;if(e)for(let[,t]of A){let r=e[t];r&&l.push(r)}}};export{H as createClearcoatFragment,V as pbrExt,M as writeClearcoatUBO};
