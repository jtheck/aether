...
`,c={className:"PerturbNormalBlock",stage:"fragment",emit(r,u,t,o,e){o.fragment.helpers.set(v,m);let s=e.cast(e.resolve(r,"worldPosition",t,o),"vec3f").expr,d=e.cast(e.resolve(r,"worldNormal",t,o),"vec3f").expr,n=e.cast(e.resolve(r,"uv",t,o),"vec2f").expr,l=e.cast(e.resolve(r,"normalMapColor",t,o),"vec3f").expr,p=r.inputs.get("strength"),a=p?.source?e.cast(e.resolve(r,"strength",t,o),"f32").expr:"1.0";return{expr:`nme_perturbNormal(${s}, ${d}, ${n}, ${l}, ${a})`,type:"vec3f"}}};export{c as emitter};
