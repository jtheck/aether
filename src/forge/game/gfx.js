...
let pov2 = 240;
  ...
  gfx.lastShadowUpdate = 0;
    ...
    // Initialize FX system (full game). Forge uses lighting.js only — skip fx + basic fallback.
    if (window.fx) {
      fx.init(scene);
      ...
      // Fallback to basic lighting if neither fx nor lighting.js loaded
      // ColorHex is Color3.FromHexString — call it, don't `new` (BJS 9 statics aren't constructors)
      scene.ambientColor = ColorHex('#696969');
      ...
      if ('specularScale' in lightDirectional) lightDirectional.specularScale = .2;
      
      let light = new BABYLON.HemisphericLight("light", new BABYLON.Vector3(0, 1, 0), scene);
      light.intensity = .9;
      if ('specularScale' in light) light.specularScale = .5;
