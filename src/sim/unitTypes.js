...
export const UNIT_DEFS = [
  ...
  },
  {
    ...
    projectileType: -1,
    minRange: 0,
    preferredRange: fx.fromFloat(1.8),
    primaryAbility: null,
  },
  {
    id: UNIT.ARCHER,
  ...
  },
  {
    ...
    attackDamage: 8,
    /** Short bumper — hull size already adds melee clearance. */
    attackRange: fx.fromFloat(1.0),
    attackCooldown: 30,
    ...
    projectileType: -1,
    minRange: 0,
    preferredRange: fx.fromFloat(1.0),
    primaryAbility: null,
    transportCapacity: 6,
    mechanical: true,
