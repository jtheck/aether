...
`;function r(o){return o?`var anisoT = normalize(input.worldTangent);
...
}`}var l=`let aniso_alphaTB = getAnisotropicRoughness(directAlphaG, material.anisotropyParams.x);
...
let G = V_GGXCorrelated_Anisotropic(NdotL, NdotV, dl_TdotV, dl_BdotV, dl_TdotL, dl_BdotL, aniso_alphaTB);`,d=`let anisoIntensity = material.anisotropyParams.x;
...
let R_raw = reflect(-V, anisoBentNormal);`,p={id:"anisotropy",phase:"fragment",writeUbo(o,s,t){let a=s.anisotropy;if(!a?.isEnabled||!t.has("anisotropyParams"))return;let n=t.get("anisotropyParams")/4,i=a.direction??[1,0];o[n]=a.intensity??1,o[n+1]=i[0],o[n+2]=i[1]}};export{d as ANISO_BENT_NORMAL,e as ANISO_BRDF_FUNCTIONS,l as ANISO_DIRECT_DG,r as makeAnisotropyTBBlock,p as pbrExt};
