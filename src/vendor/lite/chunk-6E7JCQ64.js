...
return out;
}`,Z=a?.uvForNormal??"input.uv",re=a?.normalScaleMod??"",L=a?.normalScaleMod?"scaledNormal":"normalMapRaw",J=a?.normalScaleMod?"scaledNormalCT":"normalMapSample",de;W?de=`let normalMapRaw=textureSample(normalTexture,normalSampler_,${Z}).rgb*2.0-1.0;
${re}let normalMapNorm=normalize(${L});
let N_geom=normalize(input.worldNormal);
let TBN=mat3x3<f32>(input.worldTangent,input.worldBitangent,input.worldNormal);
var N=normalize(TBN*normalMapNorm);`:z?de=`let normalMapSample=textureSample(normalTexture,normalSampler_,${Z}).rgb*2.0-1.0;
...
var N=normalize(cotangentFrame*normalize(${J}));`:de=`let N_geom=normalize(input.worldNormal);
var N=N_geom;`;let Ve=w?te:"",Te=a?.baseColorMod??"",Ce=G?"*material.baseColorFactor.rgb":"",Le=G?"*material.baseColorFactor.a":"",Fe=k?`var baseColor=pow(baseColorSample.rgb,vec3<f32>(2.2))${Ce};
var alpha=baseColorSample.a${Le};${Te}`:`var baseColor=baseColorSample.rgb${Ce};
var alpha=baseColorSample.a${Le};${Te}`,He=a?.uvForSpecGloss??"input.uv",Ue=E?`let specGloss=textureSample(specGlossTexture,specGlossSampler,${He});
...
/*BL*/`,Q=b&&v!=="",We=Q?g:"",ze=b?Q?v:`color*=scene.vImageInfos.x;
...
/*BC*/
${ct}`}
}`;return{_vertexTemplate:ae,_fragmentTemplate:ut,_baseMeshUboFields:le,_baseMaterialUboFields:ie,_baseVertexAttributes:Y,_baseVaryings:oe,_baseBindings:O}}function No(t){let r=new Map,{_singleLightWGSL:l,_getSingleLightBlock:f,_multiLightWGSL:c,_multiLightLoop:s,_acesHelpers:B,_acesTonemapCall:M,_fogHelper:T,_fogBlock:P,_createPbrTemplateExt:h,_anisoExt:n,_iblSkyboxCalc:m,_createPbrShadowFragment:E,_shadowLights:H,_createThinInstanceFragment:b}=t;return function(A,g=0,v=0,S=0,x=0,k="",G="",q,K=""){let p=`${A}:${g}:${v}:${S}:${x}:${k}${K}`,y=r.get(p);if(y)return y;let _=L=>(A&L)!==0,w=L=>(v&L)!==0,j=L=>(S&L)!==0,te=_(we)&&w($e),a=_(we)&&!w($e),D=te||a,X=_(Zt|Jt)||(g&lo)!==0,ne=j(gt),C=w(fo),W=w(po),z=_(ao),_e=_(to),Y=_(ht),oe=w(xt),le=(g&no)!==0,ie=w(At),I=(g&st)!==0&&w(nt),O=le||ie||I,fe=_(eo),ce=O&&h?h({_hasUvTransform:le,_hasVertexColor:ie,_hasUv2:I,_hasOcclusionUv2:I,_hasAnyNormal:D,_hasEmissiveTexture:Y,_hasSpecGloss:_(rt)}):void 0,ge=Po({_hasSingleLight:x===1,_hasMultiLight:x===2,_singleLightWGSL:l,_singleLightBlock:x===1&&f?f(k):"",_multiLightWGSL:c,_multiLightLoop:s,_normalMode:te?"tangent":a?"cotangent":"none",_hasEmissiveTexture:Y,_hasSpecGloss:_(rt),_hasDoubleSided:_(St),_hasTonemap:j(vt),_fogHelper:j(ot)?T:"",_fogBlock:j(ot)?P:"",_acesHelpers:B,_acesTonemapCall:M,_hasAlphaBlend:_(at),_hasSpecularAA:fe,_hasGammaAlbedo:_(oo),_hasBaseColorFactor:(g&io)!==0,_hasMorph:C,_hasOcclusion:_(Qt)&&!X,_hasEmissiveColor:_e,_hasReflectanceExt:X,_hasIbl:ne,_hasAnisotropy:z,_anisoBrdfFunctions:z&&n?n.ANISO_BRDF_FUNCTIONS:"",_anisoTBBlock:z&&n?n.makeAnisotropyTBBlock(te):"",_ext:ce,_noColorOutput:(g&Oe)!==0,_esmShadowOutput:(g&he)!==0,_esmShadowDepthCode:G,_vbStrides:q}),ae=[],Z={_features:A,_features2:g,_meshFeatures:v,_hasIbl:ne,_hasAnyNormal:D,_hasSpecularAA:fe,_anisoBentNormalCode:z&&n?n.ANISO_BENT_NORMAL:"",_iblSkyboxCalc:_(ro)?m:""};for(let L of bt().values())if(L.frag){let J=L.frag(Z);J&&ae.push(J)}if(W&&E){let L=H.map(J=>({lightIndex:J.lightIndex,shadowType:J.shadowType}));ae.push(E(L))}oe&&b&&ae.push(b(w(Bt)));let re=Ht(ge,ae);return r.set(p,re),re}}async function Eo(t,r,l){var f,c,s,B,M,T,P,h;let n=t.surface.engine,m=n._device,E=new Map,H=!!l,b=[];for(let o=0;o<t.lights.length;o++){let e=t.lights[o].shadowGenerator;e&&b.push({lightIndex:o,shadowType:e._shadowType,gen:e})}let U=b.length>0,A=!1,g=!1,v=!1,S=[];for(let o of r){let e=Ie(o,t.lights),u=e>0?1:-e;if(A||(A=u>0),u===1&&!(o.receiveShadows&&U)){g=!0;let Q=go(t.lights,e-1);S.includes(Q)||S.push(Q)}else u>0&&(v=!0)}let x=!1,k=!1,G=!1,q=!1,K=!1,p=!1,y=!1,_=!1,w=!1,j=!1,te=!1,a=!1,D=!1,X=!1,ne=!1,C=!1,W=!1,z=!1;for(let o=0;o<r.length;o++){let e=r[o],u=e.material,Q=((c=(f=u.subsurface)==null?void 0:f.refraction)==null?void 0:c.intensity)??0;x||(x=!!u.skyboxMode),k||(k=!!(u.metallicReflectanceTexture||u.reflectanceTexture||u._hasReflExt)),G||(G=!!((s=u.clearCoat)!=null&&s.isEnabled)),q||(q=!!((B=u.sheen)!=null&&B.isEnabled)),K||(K=!!((M=u.iridescence)!=null&&M.isEnabled)),p||(p=!!((T=u.anisotropy)!=null&&T.isEnabled)),y||(y=!!((P=u.subsurface)!=null&&P.translucency)),_||(_=u.alphaCutOff>0),w||(w=Q>0&&!!u.transmissive),j||(j=!!u.emissiveColor),te||(te=!!e.skeleton),a||(a=!!e.morphTargets),D||(D=!!e.thinInstances),X||(X=!!((h=e.thinInstances)!=null&&h._gpuCullingEnabled)),ne||(ne=!!u.unlit),C||(C=!!u._hasUvTx),W||(W=!!e._gpu.uv2Buffer&&u.occlusionTexCoord===1),z||(z=!!e._gpu.colorBuffer)}let _e="";if(H){let o=await import("./ibl-fragment-DqQVi8k0-3R4CKCKV.js");Re(o.pbrExt),x&&(_e=(await import("./ibl-skybox-wgsl-DCah0kWV-FHKT6ARY.js")).IBL_SKYBOX_CALCULATION)}let Y=null,oe="",le=null,ie={},I="",O="";if(g){for(let o of S){let e=await Go(o);oe=e.SINGLE_LIGHT_STRUCTS,ie[o]=e.getSingleLightBlock}le=o=>{var e;return((e=ie[So(o)])==null?void 0:e.call(ie))??""}}if(v){let o=await import("./multilight-wgsl-I5SncF0q-P4LUS3QE.js");I=o.MULTI_LIGHT_STRUCTS()+o.COMPUTE_PBR_LIGHT,O=o.getMultiLightLoop()}A&&U&&(Y=(await import("./pbr-shadow-fragment-waeIBQUq-AOABLRSL.js")).createPbrShadowFragment);let fe=async o=>{for(let[e,u]of o)e&&Re((await u()).pbrExt)};await fe([[_,()=>import("./alpha-test-fragment-x2mnjLgC-RMLRVWFD.js")],[k,()=>import("./reflectance-fragment-BQFZ_pgy-CBN3BTVW.js")],[G,()=>import("./clearcoat-fragment-Dj7vGX2u-7T7I6E7X.js")],[q,()=>import("./sheen-fragment-B_Jd7wrr-MILPRDGD.js")],[K,()=>import("./iridescence-fragment-kfsCs8lN-5SZ7CXCB.js")],[y,()=>import("./subsurface-fragment-BNQoG9gr-NTOHZP7P.js")]]),w&&await(await import("./pbr-refraction-Dxsm_gii-HNRCAF36.js")).registerPbrRefraction(t,n,Re),await fe([[j,()=>import("./emissive-fragment-BOAezkfk-6EEHM2DA.js")],[ne,()=>import("./unlit-fragment-BsHrS9XX-QLYINPTH.js")],[te,()=>import("./skeleton-fragment-COdHWFcK-JKARF5DP.js")],[a,()=>import("./morph-fragment-NpZYyIIU-TMZ6SWZK.js")],[C,()=>import("./uv-transform-fragment-hYujGpZg-BE35SAA6.js")]]);let ce=null;p&&(ce=await import("./anisotropy-fragment-HgasXS7l-OUFQ57BY.js"),Re(ce.pbrExt));let ge=null;(C||z||W)&&(ge=(await import("./pbr-template-ext-CGgB2n2y-73KFZ2AY.js")).createPbrTemplateExt);let ae=null,Z=null,re,L=null;if(D){ae=(await import("./thin-instance-fragment-hsv-RyDs-FWP7UWCF.js")).createThinInstanceFragment;let e=await import("./thin-instance-gpu-C1DGstap-BWKZLFKK.js");Z=e.syncThinInstanceBuffers,X&&(re=await import("./thin-instance-cull-binding-BNC5JiGw-TI2GVASK.js")),L=e.syncThinInstanceGpuData}let J="",de="",Ve=t.imageProcessing.toneMappingEnabled;if(Ve&&t.imageProcessing.toneMappingType==="aces"){let o=await import("./pbr-aces-wgsl-HpiQHGN_-PTZQL5B3.js");J=o.ACES_HELPERS_WGSL,de=o.ACES_TONEMAP_CALL_WGSL}let Te="",Ce="";if(t.fog){let o=await import("./pbr-fog-wgsl-BqdCid6r-A4YRYJ6C.js");Te=o.PBR_FOG_HELPER,Ce=o.PBR_FOG_BLOCK}let Le=No({_singleLightWGSL:oe,_getSingleLightBlock:le,_multiLightWGSL:I,_multiLightLoop:O,_acesHelpers:J,_acesTonemapCall:de,_fogHelper:Te,_fogBlock:Ce,_createPbrTemplateExt:ge,_anisoExt:ce,_iblSkyboxCalc:_e,_createPbrShadowFragment:Y,_shadowLights:b,_createThinInstanceFragment:ae}),Fe=(H?gt:0)|(Ve?vt:0)|(t.fog?ot:0),He=new Map,Ue=Z,ke=L,De=(o,e,u)=>{var Q,We;let ze=u??e.material,N=ze,qe=N._renderFeatures??(N._renderFeatures=uo(N)),ct=u!=null,Me=e,Pe=Ie(e,o.lights),Ke=Pe>0?1:-Pe,ve=qe.features,se=qe.features2??0,Ne=!((se&(Oe|he))!==0)&&e.receiveShadows&&U,Ee=Ke===0?0:Ke===1&&!Ne?1:2,je=Ee===1?go(o.lights,Pe-1):"",ue=mo(e,Ne),ut=(se&he)!==0?N._esmShadowDepthCode:"",_t=Me._gpu._vbLayout,Xe=Me._gpu._vbKey??"",Ge=Le(ve,se,ue,Fe,Ee,je,ut,_t,Xe),pe=Lo(n,ve,se,ue,Fe,Ge,`${Ee}:${je}${Xe}`),Se=new tt(Ge._meshUboSpec._totalBytes/4),Lt=((Q=n._makePackMeshWorld)==null?void 0:Q.call(n,o))??zt;Lt(Se,e.worldMatrix,0,0),Ie(e,o.lights,Se);let Ye=mt(n,Se),be=Ge._materialUboSpec,Ft=new tt(be._totalBytes/4);Tt(Ft,N,be);let Ze=mt(n,Ft),xe=!!N.transmissive&&(se&so)!==0,bo=xe?null:ho(n,pe,Ge,Ye,Ze,N,l??null,e),ft=null,Mt=Ne?b:[];if(Mt.length>0&&pe._shadowBGL){let i=He.get(pe._shadowBGL);if(!i){let R=[],d=0;for(let Ae of Mt){let ee=Ae.gen;R.push({binding:d++,resource:ee._depthTexture.createView()}),R.push({binding:d++,resource:ee._depthSampler}),R.push({binding:d++,resource:{buffer:ee._shadowUBO}})}i=m.createBindGroup({layout:pe._shadowBGL,entries:R}),He.set(pe._shadowBGL,i)}ft=i}let Pt=_o(N);for(let i of Pt)jt(i);o._meshDisposables.set(e,[()=>{Ye.destroy(),Ze.destroy()},()=>{for(let i of Pt)Xt(i)}]);let Je=(se&(Oe|he))===0&&(ve&at)!==0,xo=e.renderOrder??(Je||xe?150:100),Bo=(ve&we)!==0,Ao=(se&st)!==0&&(ue&nt)!==0,yo=(ue&At)!==0,Nt=(ue&xt)!==0,dt=(ue&Bt)!==0,pt=e.worldMatrixVersion,Et=o.lights.length,Be=Je||xe?[e.worldMatrix[12],e.worldMatrix[13],e.worldMatrix[14]]:null,Gt=()=>{let i=e.worldMatrixVersion;(i!==pt||o.lights.length!==Et)&&(Be&&(Be[0]=e.worldMatrix[12],Be[1]=e.worldMatrix[13],Be[2]=e.worldMatrix[14]),Lt(Se,e.worldMatrix,0,0),Ie(e,o.lights,Se),m.queue.writeBuffer(Ye,0,Se),pt=i,Et=o.lights.length);let R=N._uboVersion;if(R!==Ot){Ot=R;let d=E.get(be._totalBytes);d?d.fill(0):(d=new tt(be._totalBytes/4),E.set(be._totalBytes,d)),Tt(d,N,be),m.queue.writeBuffer(Ze,0,d.buffer,0,d.byteLength)}if(Nt&&ke){let d=e.thinInstances;d&&ke(n,d,dt)}},wo=()=>{pt=-1},It=((We=n._wrapRenderableForFO)==null?void 0:We.call(n,Gt,o,wo))??Gt,To=(i,R,d)=>{var Ae,ee,et,Rt,$t,Vt;if(!ct&&e.material!==ze)return 0;let F=Me._gpu;i.setBindGroup(1,R),ft&&i.setBindGroup(2,ft);let $=0,V=F._vbLayout;i.setVertexBuffer($++,F.positionBuffer,(Ae=V?._p)==null?void 0:Ae._offset),i.setVertexBuffer($++,F.normalBuffer,(ee=V?._n)==null?void 0:ee._offset),Bo&&F.tangentBuffer&&i.setVertexBuffer($++,F.tangentBuffer,(et=V?._t)==null?void 0:et._offset),i.setVertexBuffer($++,F.uvBuffer,(Rt=V?._u)==null?void 0:Rt._offset),Ao&&F.uv2Buffer&&i.setVertexBuffer($++,F.uv2Buffer,($t=V?._u2)==null?void 0:$t._offset),yo&&F.colorBuffer&&i.setVertexBuffer($++,F.colorBuffer,(Vt=V?._c)==null?void 0:Vt._offset);let me=e.skeleton??e.vat;me&&(i.setVertexBuffer($++,me.jointsBuffer),i.setVertexBuffer($++,me.weightsBuffer),me.joints1Buffer&&me.weights1Buffer&&(i.setVertexBuffer($++,me.joints1Buffer),i.setVertexBuffer($++,me.weights1Buffer)));let ye=Nt?e.thinInstances:null;return ye&&Ue&&($=Ue(n,ye,i,$,dt,d?.cullDrawBufs)),i.setIndexBuffer(F.indexBuffer,F.indexFormat),d?d.draw(i,F.indexCount,ye.count):ye&&ye.count>0?i.drawIndexed(F.indexCount,ye.count):i.drawIndexed(F.indexCount),1},Qe={order:xo,isTransparent:Je,_transmissive:xe,mesh:e,bind(i,R){let d=Fo(i,R,pe),Ae=xe?ho(n,pe,Ge,Ye,Ze,N,l??null,e,R._transmissionTexture):bo,ee=re?.tryBind(Qe,o,e,n,dt,Je||xe,It);return{renderable:Qe,pipeline:d,update:ee?ee.update:It,draw:et=>To(et,Ae,ee)}}};Be&&(Qe._worldCenter=Be);let Ot=N._uboVersion;return Qe},it=r.map(o=>De(t,o));return t._pbrGeomContext={_composePbr:Le,_sceneFeatures:Fe,_envTextures:l??null,_shadowLights:b,_syncThinInstanceBuffers:Z},t._disposables.push(()=>Co(),()=>Yt(n)),{renderables:it,rebuildSingle:De}}function So(t){return t==="hemispheric"||t==="directional"||t==="spot"?t:"point"}function go(t,r){let l=0;for(let f of t)if(f._writeLightUbo){if(l===r)return So(f.lightType);l++}return"point"}async function Go(t){return t==="hemispheric"?import("./singlelight-hemispheric-wgsl-DjxhgI8r-T34C4Y47.js"):t==="directional"?import("./singlelight-directional-wgsl-Bw84txva-Z6RGDCF7.js"):t==="spot"?import("./singlelight-spot-wgsl-MDdTdstF-ZRG7S7L4.js"):import("./singlelight-point-wgsl-iA1aRkXA-UZ7YXSCI.js")}function Tt(t,r,l){t[0]=r.environmentIntensity??1,t[1]=r.directIntensity??1,t[2]=r.reflectance??.04,t[3]=r.alpha??1;let f=l._offsets.get("baseColorFactor");if(f!==void 0){let c=f/4,s=r.baseColorFactor;t[c]=s?s[0]:1,t[c+1]=s?s[1]:1,t[c+2]=s?s[2]:1,t[c+3]=s?s[3]:1}if(l._offsets.has("metallicFactor")){let c=l._offsets.get("metallicFactor")/4;t[c]=r.metallicFactor??1,t[c+1]=r.roughnessFactor??1,t[c+2]=r.normalTextureScale??1,t[c+3]=r.usePhysicalLightFalloff===!1?0:1}for(let c of bt().values())c.writeUbo&&c.writeUbo(t,r,l._offsets)}var Ro=Object.freeze(Object.defineProperty({__proto__:null,_writeMaterialData:Tt,buildPbrRenderables:Eo},Symbol.toStringTag,{value:"Module"}));export{ho as a,Tt as b,Ro as c};
