import{b as C}from"./chunk-6R3BZD2T.js";import{a as F}from"./chunk-NNQPQCUH.js";import{$ as M,$d as D,R as V,S as w,V as O,Y as g,_ as A,a as G,fe as $,ie as z,ih as X,je as I,lf as k,ne as W,o as T,oe as H,p as P,qe as B,se as b,xe as N,ye as U,ze as R}from"./chunk-2GVZXICG.js";var se=1,S=2,ie=`
...
`,j=r?C:C+ie,Q=`@fragment fn main(input: FragmentInput)${c?"":" -> @location(0) vec4<f32>"} {`,J=r?"":"let viewDirectionW = normalize(scene.vEyePosition.xyz - input.vp);",q=r?"":"var normalW = normalize(input.vn);",Z="var alpha = mat.dc.a;",ee=a?`let _ds = textureSample(dT, dS, ${n?"input.vv":"input.vu"});
