import{a as t}from"./chunk-VQHJJFNH.js";function r(e){if(e.useClearcoat||e.useSheen||e.useRefraction||e.useSubsurface||e.useAnisotropy||e.useIridescence||e.useShAlbedoScaling||e.useCcBump||e.useCcTint||e.useSpecularAA||e.remapClearcoatF0)throw new Error("NodeMaterial: PBR-MR core helper cannot emit optional PBR feature code");return a(e.useEnv)}function a(e){return`alias v2 = vec2<f32>;
alias v3 = vec3<f32>;
alias v4 = vec4<f32>;
