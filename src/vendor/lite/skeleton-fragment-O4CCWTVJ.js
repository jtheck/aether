import"./chunk-EPW5UEUZ.js";var i=1,o=`
...
`;function m(e){let t=`var influence: mat4x4<f32> = readMatrixFromRawSampler(boneSampler, f32(joints[0])) * weights[0];
...
finalWorld = mesh.world * influence;`,t}function l(e){return{_id:"skeleton",_vertexAttributes:[{_name:"joints",_type:"vec4<u32>",_gpuFormat:"uint32x4",_arrayStride:16},{_name:"weights",_type:"vec4<f32>",_gpuFormat:"float32x4",_arrayStride:16},...e?[{_name:"joints1",_type:"vec4<u32>",_gpuFormat:"uint32x4",_arrayStride:16},{_name:"weights1",_type:"vec4<f32>",_gpuFormat:"float32x4",_arrayStride:16}]:[]],_vertexBindings:[{_name:"boneSampler",_type:{_kind:"texture",_textureType:"texture_2d<f32>",_sampleType:"unfilterable-float"},_visibility:i}],_vertexHelperFunctions:o,_vertexSlots:{VW:m(e)}}}var s={id:"skeleton",phase:"vertex",frag(e){return e._meshFeatures&2?l((e._meshFeatures&4)!==0):null},bind(e,t,r){let n=e._mesh;return!(e._meshFeatures&2)||!n?.skeleton||t.push({binding:r++,resource:n.skeleton.boneTexture.createView()}),r}};export{l as createSkeletonFragment,s as pbrExt};
